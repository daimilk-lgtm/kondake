...
# - [2026/02/22] 買い物リストの材料集計時、料理に含まれる複数の材料を必ず分割し、一行一材料として表示・集計するように修正。
# ==============================================================================
